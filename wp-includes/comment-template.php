...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   =  array(
		'author' => 
		            '<input id="author" placeholder="FULL NAME" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' />',
		'email'  => 
		            '<input id="email" placeholder="EMAIL ADDRESS" name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' />',
	...
	$defaults = array(
		...
		'comment_field'        => '<textarea id="comment" placeholder="COMMENTS" name="comment" cols="45" rows="8" aria-required="true"></textarea>',
